        ...
        std::vector<Rewrap::Structure> make_supercells(Rewrap::Structure &structure, int min_vol, int max_vol)
{
    ...
    CASM::SupercellEnumerator<CASM::Lattice> e(structure.lattice(), enum_props);
    // This did not work. Get segmentation errors on third line.
    //CASM::PrimClex primclex(structure, CASM::null_log());
    //CASM::PrimClex * pclex = new CASM::PrimClex(structure, CASM::null_log());
    //CASM::ScelEnumByProps e(*pclex, enum_props);
    ...
    for(; it != end; ++it, ++count) {
            ...
            auto super = structure.create_superstruc(*it);
